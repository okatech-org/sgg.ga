          ...
          <div className="relative grid lg:grid-cols-2 gap-8 lg:gap-12 p-8 md:p-12 lg:p-16">
            ...
            <div className="hidden lg:flex items-center justify-center">
              <div className="relative">
                ...
                {/* Orbiting Elements */}
                <div className="absolute -top-8 -right-8 h-20 w-20 rounded-xl bg-white/10 backdrop-blur-sm border border-white/20 flex items-center justify-center animate-pulse">
                  <span className="text-2xl font-bold text-white">35</span>
                </div>
                <div className="absolute -bottom-4 -left-12 h-24 w-24 rounded-xl bg-government-gold/20 backdrop-blur-sm border border-government-gold/30 flex flex-col items-center justify-center">
                  <span className="text-2xl font-bold text-government-gold">24/7</span>
                  <span className="text-xs text-white/70">Disponible</span>
                </div>
                <div className="absolute top-1/2 -right-16 h-16 w-16 rounded-full bg-government-green/20 border border-government-green/30 flex items-center justify-center">
